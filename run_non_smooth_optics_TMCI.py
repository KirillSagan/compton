...
wake_table_geom_long,slicer = make_Impedance(tmp_filename, bunch,n_slices = n_slices, 
                                      fixed_cuts_perc_min_max = fixed_cuts_perc_min_max,
                                      list_ = ['time','longitudinal'],  slicing_mode = slicing_mode,
                                      n_sigma_z = n_sigma_z)
...
wake_table_geom_trans_x,slicer = make_Impedance(tmp_filename,bunch, n_slices = n_slices, 
                                       fixed_cuts_perc_min_max = fixed_cuts_perc_min_max,
                                       list_ = ['time','dipole_x',
                                                'quadrupole_x'],
...
wake_table_geom_trans_y,slicer = make_Impedance(tmp_filename,bunch, n_slices = n_slices, 
                                       fixed_cuts_perc_min_max = fixed_cuts_perc_min_max,
                                       list_ = ['time','dipole_y',
                                                'quadrupole_y'],
                                       slicing_mode = slicing_mode,
...
wake_table_rw_long,slicer = make_Impedance(tmp_filename, bunch, n_slices = n_slices, 
                                    fixed_cuts_perc_min_max = fixed_cuts_perc_min_max,
                                    list_ = ['time','longitudinal'],  slicing_mode = slicing_mode,
                                    n_sigma_z = n_sigma_z)
...
wake_table_rw_trans_x,slicer = make_Impedance(tmp_filename, bunch, n_slices = n_slices, 
                                     fixed_cuts_perc_min_max = fixed_cuts_perc_min_max,
                                     list_ = ['time','dipole_x',
                                              'quadrupole_x'],
                                     slicing_mode = slicing_mode,
...
wake_table_rw_trans_y,slicer = make_Impedance(tmp_filename, bunch, n_slices = n_slices, 
                                     fixed_cuts_perc_min_max = fixed_cuts_perc_min_max,
                                     list_ = ['time','dipole_y',
                                              'quadrupole_y'],
                                     slicing_mode = slicing_mode,
...
Impedance_long = Impedance(slicer, *list_of_wake_sources_long)
Impedance_x = Impedance(slicer, *list_of_wake_sources_x)
Impedance_y = Impedance(slicer, *list_of_wake_sources_y)


## Putting everything at an instance of our ring (machine.one_turn_map)
machine.one_turn_map.insert(n_betax_avr, Impedance_x)
machine.one_turn_map.insert(n_betay_avr, Impedance_y)
machine.one_turn_map.append(Impedance_long)
"""n_BEND_1 = 18
n_BEND_2 = 22
n_BEND_3 = 47
n_BEND_4 = 51
